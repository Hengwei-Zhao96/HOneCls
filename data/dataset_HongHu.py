...
class NewOccHongHuDataset(OccFullImageDataset):
    def __init__(self, config):
        ...
        super(NewOccHongHuDataset, self).__init__(image=image,
                                                  mask=mask,
                                                  cls=self.cls,
                                                  ratio=config['ratio'],
