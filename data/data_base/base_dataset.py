...
from data.data_utils.data_preprocess import divisible_pad
from data.data_utils.minibatch_sample import minibatch_sample
...
class OccFullImageDataset(data.dataset.Dataset):
    ...
    def get_unlabeled_train_indicator(self):
        ...
        unlabeled_train_indicator[:min(int(self.num_train_samples_per_class * self.ratio), gt_mask_flatten.shape[0])] = 1
